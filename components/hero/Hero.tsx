  ...
  return (
    <section className="relative container mx-auto min-h-[70vh] px-6 overflow-hidden mt-10">
      ...
      <div className="absolute inset-0 h-[70vh]">
        <Image
          src={heroMattress}
          alt="EcoSpine Premium Mattress - Sog'lom uyqu uchun ideal tanlov"
          fill
      ...
      <div className="relative z-10  mx-auto  py-20 px-14">
        <div className="max-w-lg">
          ...
          {/* Subtitle */}
          <p className="text-2xl md:text-3xl font-bold mb-4 text-white">sifatingizning kafolati</p>

          {/* Description */}
          <p className="text-lg mb-8 leading-relaxed text-white">
            Eng so'nggi innovatsion texnologiyalardan foydalangan holda yaratilgan matraslarimiz
            tanangizga ideal moslashadi.
          </p>
      ...
      <div className="hidden md:block absolute top-[400px] right-16 transform -translate-y-1/2 z-20 px-14">
        <div className="bg-white/40 backdrop-blur-sm rounded-2xl p-6 shadow-xl w-[450px] border border-white/20">
          {/* Product Name */}
          <h3 className="text-2xl md:text-3xl font-bold text-primary mb-2">COMFORT+ Matras</h3>

          {/* Slogan */}
          <p className="text-sm text-foreground mb-4">Yuksak sifatli uyqu uchun mukammal tanlov</p>

          {/* Prices */}
          <div className="space-y-2">
            <p className="text-lg text-foreground line-through">2,500,000 so'm</p>
            <p className="text-3xl font-bold text-yellow-500">1,750,000 so'm</p>
          </div>
        </div>
      </div>
